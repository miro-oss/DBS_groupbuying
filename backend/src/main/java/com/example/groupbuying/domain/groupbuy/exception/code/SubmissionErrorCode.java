...
public enum SubmissionErrorCode implements BaseErrorCode {
    ...
    SELLER_CANNOT_COMPLETE(HttpStatus.FORBIDDEN, "SUBMISSION403_2", "판매자는 '거래완료'로 변경할 수 없습니다. 구매자의 수령 확인이 필요합니다."),
    BUYER_CANNOT_COMPLETE(HttpStatus.BAD_REQUEST, "SUBMISSION400_2", "'배송중' 상태일 때만 거래 완료(수령 확인)를 할 수 있습니다.")
    ;
