    ...
    <div className="container">
      <div className="form-container" style={{maxWidth:'800px'}}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label>가격 (1개당)</label>
            <input type="number" name="pricePerUnit" className="form-control" value={form.pricePerUnit} onChange={handleChange} required />
          </div>
          ...
          <div className="form-group">
            ...
            {preview && (
                <div style={{marginTop:'10px'}}>
                    ...
                    <img src={preview} alt="미리보기" style={{width:'200px', height:'200px', objectFit:'cover', borderRadius:'8px', border:'1px solid #ddd'}} />
                </div>
            )}
          </div>
          ...
          <div style={{display:'flex', gap:'10px'}}>
             ...
             <input name="accountNumber" placeholder="계좌번호" className="form-control" value={form.accountNumber} onChange={handleChange} required />
